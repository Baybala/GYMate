...
const Section4 = () => {
  return (
    <div className="head-sec5">
      <img src="./titlebx.svg" alt="titlebx" />
      <h4 className="head-sec5-headText_gymTrainers">GYM TRAINERS</h4>
      <h1 className="head-sec5-headText_teamOfExpertCouches">
        <b>Team Of Expert Coaches</b>
      </h1>
      <p className="head-sec5-paragraphText">
        Expert team of coaches helps you succeed in any goal, personalized
        guidance and motivation provided!
      </p>
      <div className="head-sec5-coaches">
        <div>
          <div className="head-sec5-coacheImage">
            <img src="./pictures/Im1.png" alt="coach" />
          </div>
          <div className="head-sec5-coacheInfo">
